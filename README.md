...
Time travel expedition game

<!-- MG-GAME-SHOWCASE:START -->
## Gameplay Showcase

![Time Slip Explorers gameplay screen](docs/images/gameplay-showcase.png)

**Time Slip Explorers** centers on the **Collect and Share** loop. The player enters from the main menu, reads the active objective and pressure state, performs the core action, banks rewards, then returns through roadmap and retention goals.

- **Primary flow:** Main menu -> Start Game -> Gameplay objective -> Complete Action -> Reward bank -> Level roadmap -> Return loops.
- **Level design:** 8-stage progression from `L1 Onboarding: Complete the set: Learn the core action` to `L8 Repeatable Loop: Complete the set: Return for a harder run and better reward`.
...
git clone --recursive https://github.com/monthly-games/mg-game-0020.git
